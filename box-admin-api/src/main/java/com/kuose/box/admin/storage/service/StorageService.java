...
import com.kuose.box.common.utils.CharUtil;
...
public class StorageService {
     ...
     */
    public BoxStorage store(InputStream inputStream, long contentLength, String contentType, String fileName) {
    ...
    private String generateKey(String originalFilename) {
        ...
        String key = null;
        BoxStorage storageInfo = null;

        do {
            key = CharUtil.getRandomString(20) + suffix;
            storageInfo = boxStorageService.getOne(new QueryWrapper<BoxStorage>().eq("storage_key", key));
        }
